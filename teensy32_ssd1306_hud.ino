...
void setup() {
  ...
  // testanimate(up_arrow, LOGO_WIDTH, LOGO_HEIGHT); // Animate bitmaps
  // ledToggle();
  }
...
void renderOledE_compass() {
  ...
  switch (dir) {
    ...
    case 1:
      ...
      x++;
      display.drawBitmap(x, COMPASS_Y, up_arrow_r, LOGO_WIDTH, LOGO_HEIGHT, SSD1306_WHITE);
      dir_up_count++;
      break;
    ...
    case -1:
      display.fillRect(x, COMPASS_Y, LOGO_WIDTH, LOGO_HEIGHT, SSD1306_BLACK);
      x--;
      display.drawBitmap(x, COMPASS_Y, up_arrow_l, LOGO_WIDTH, LOGO_HEIGHT, SSD1306_WHITE);
      dir_dn_count++;
      break;

    default:
    case 0:
      display.drawBitmap(x, COMPASS_Y, up_arrow, LOGO_WIDTH, LOGO_HEIGHT, SSD1306_WHITE);
      def_count++;
      break;
  }
